...
> Answer: The benefits of using client-side routing is that the page will not have to download or reload everytime. The requests to the sites server happens one time. Data will load faster. 
